...
- AC9: Las gráficas de torta y anillo muestran el porcentaje numérico dentro de cada porción (porciones legibles) y en la leyenda de las opciones; las gráficas de barras no se modifican.
- AC10: "Respuesta al Cambio" tiene UNA sola leyenda, en lista HTML, con un cuadro de color visible por opción, texto completo sin cortes y colores idénticos a los del anillo; no existe bloque de texto duplicado.
...
- [x] Commit y push revisados (`6f18ca6` + `b89420b` + `bba369f`).
